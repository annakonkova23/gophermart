...
func (as *AccumulationSystem) saveStatusOrderDB(order *model.Order) error {
	query := `
...
func (as *AccumulationSystem) saveEndStatusOrderDB(ctx context.Context, order *model.Order) {
